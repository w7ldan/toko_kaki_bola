...
from main.views import get_user_products, show_main, create_product, show_product, show_xml, show_json, show_xml_by_name, show_json_by_name, register, login_user, logout_user, clear_products, edit_product, delete_product, add_product_entry_ajax, edit_product_ajax, delete_product_ajax, register_ajax, login_ajax, proxy_image, create_product_flutter
